...
class WechatMobileOauth extends AbstractOauth
{
    ...
    {
        return '<a href="' . modstart_web_url('oauth_login_wechatmobile', ['redirect' => Input::get('redirect', modstart_web_url(''))]) . '" class="wechat"><i class="iconfont icon-wechat"></i></a>';
    }

    private function proxy()
    {
        return modstart_config()->getWithEnv('oauthWechatMobileProxy');
    }
    ...
    private function socialite($param)
    {
        $socialite = new SocialiteManager([
            'wechat' => [
                'client_id' => modstart_config()->getWithEnv('oauthWechatMobileAppId'),
                'client_secret' => modstart_config()->getWithEnv('oauthWechatMobileAppSecret'),
