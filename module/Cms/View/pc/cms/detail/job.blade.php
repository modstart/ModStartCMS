...
@section('bodyContent')
    ...
    <div class="tw-text-white tw-text-lg tw-py-20 tw-bg-transparent ub-cover" style="background-image:url({{\ModStart\Core\Assets\AssetsUtil::fixFullOrDefault($cat['bannerBg'],'vendor/Cms/bg/job.jpg')}});">
