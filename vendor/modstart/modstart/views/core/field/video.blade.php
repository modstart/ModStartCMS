<div class="line" id="{{$id}}">
    ...
    <div class="field">
        <input type="hidden"
               ...
               value="{{$value}}"/>
        <div id="{{$name}}Selector" class="ub-video-selector @if(!empty($value)) has-value @endif">
...
.ub-video-selector .tools .close{display:none;}
.ub-video-selector.has-value .tools .close{display:inline-block;}
.ub-video-selector.has-value .tools .add{display:none;}
.ub-video-selector .uploader{background:transparent;}
') !!}
