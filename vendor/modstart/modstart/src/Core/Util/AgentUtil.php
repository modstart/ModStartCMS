...
class AgentUtil
{
    ...
    private static $robots = [
        ...
        // 其他一些库
        '/(curl|python|java|node-fetch|http-client|msray-plus|guzzlehttp|wget|okhttp|scrapy|panelstart|node-superagent|go-camo|cpp-httplib|axios|fasthttp|https?:\\/\\/)/i' => 'Other',
        '/^(node)$/i' => 'Other',
        // 其他一些爬虫
