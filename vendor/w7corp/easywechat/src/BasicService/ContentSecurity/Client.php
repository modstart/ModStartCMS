...
class Client extends BaseClient
{
     ...
     */
    public function checkMediaAsync($mediaUrl, $mediaType)
    {
        /*
         * 1:音频;2:图片
         */
        ...
        $params = ['media_url' => $mediaUrl, 'media_type' => $mediaType];
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function checkImageAsync($mediaUrl)
    {
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function checkAudioAsync($mediaUrl)
    {
