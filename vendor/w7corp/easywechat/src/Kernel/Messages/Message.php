...
abstract class Message implements MessageInterface
{
    ...
    const ALL = self::TEXT | self::IMAGE | self::VOICE | self::VIDEO | self::SHORT_VIDEO | self::LOCATION | self::LINK | self::DEVICE_EVENT | self::DEVICE_TEXT | self::FILE | self::TEXT_CARD | self::TRANSFER | self::EVENT | self::MINIPROGRAM_PAGE | self::MINIPROGRAM_NOTICE;
    /**
     * @var string
     */
    protected $type;
    ...
    public function transformForJsonRequest(array $appends = [], $withType = true)
    {
        ...
        $data[$messageType] = array_merge(isset($data[$messageType]) ? $data[$messageType] : [], $this->propertiesToArray([], $this->jsonAliases));
        return $data;
    }
    /**
     * @param array $appends
