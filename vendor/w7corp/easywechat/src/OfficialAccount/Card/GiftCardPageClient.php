...
class GiftCardPageClient extends BaseClient
{
     ...
     * @return mixed
     */
    public function update($pageId, $bannerPicUrl, array $themeList)
    {
        $params = ['page' => ['page_id' => $pageId, 'banner_pic_url' => $bannerPicUrl, 'theme_list' => $themeList]];
     ...
     * @return mixed
     */
    public function setMaintain($pageId = '')
    {
        $params = ($pageId ? ['page_id' => $pageId] : ['all' => true]) + ['maintain' => true];
