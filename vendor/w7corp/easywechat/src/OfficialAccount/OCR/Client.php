...
class Client extends BaseClient
{
    ...
    public function idCard($path, $type = 'photo')
    {
        ...
        return $this->httpPost('cv/ocr/idcard', ['type' => $type, 'img_url' => $path]);
    }
    /**
     * Bank card OCR.
     *
    ...
    {
        return $this->httpPost('cv/ocr/bankcard', ['img_url' => $path]);
    }
    /**
     * Vehicle license OCR.
     *
    ...
    {
        return $this->httpPost('cv/ocr/drivinglicense', ['img_url' => $path]);
    }
}