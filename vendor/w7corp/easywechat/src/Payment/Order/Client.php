...
class Client extends BaseClient
{
    ...
    public function unify(array $params, $isContract = false)
    {
        ...
        $params['notify_url'] = isset($params['notify_url']) ? $params['notify_url'] : $this->app['config']['notify_url'];
        if ($isContract) {
            $params['contract_appid'] = $this->app['config']['app_id'];
            $params['contract_mchid'] = $this->app['config']['mch_id'];
            $params['request_serial'] = isset($params['request_serial']) ? $params['request_serial'] : time();
            $params['contract_notify_url'] = isset($params['contract_notify_url']) ? $params['contract_notify_url'] : $this->app['config']['contract_notify_url'];
